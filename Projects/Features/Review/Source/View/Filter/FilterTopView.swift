...
final class FilterTopView: NagazaView {
    ...
    private let resetButtonLabel: UILabel = {
        ...
        label.font = DSKitFontFamily.Pretendard.medium.font(size: 15)
    ...
    private let resetButton: UIButton = {
        ...
        button.backgroundColor = DSKitAsset.Colors.gray8.color
        button.layer.borderColor = DSKitAsset.Colors.gray3.color.cgColor
    ...
    private let applyButton: UIButton = {
        ...
        button.backgroundColor = DSKitAsset.Colors.mainOrange.color
        button.layer.borderColor = DSKitAsset.Colors.gray3.color.cgColor
        button.layer.borderWidth = 1
