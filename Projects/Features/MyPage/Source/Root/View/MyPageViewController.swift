...
final class MyPageViewController: NagazaViewController {
    ...
    private let contentsLabel: UILabel = {
        ...
        label.font = DSKitFontFamily.Pretendard.medium.font(size: 17)
    ...
    private let myInfoButton: UIButton = {
        ...
        button.layer.borderColor = DSKitAsset.Colors.gray5.color.cgColor
    ...
    private let gradeView: UIView = {
        ...
        view.layer.borderColor = DSKitAsset.Colors.gray5.color.cgColor
    ...
    private let gradeInfoLabel: UILabel = {
        ...
        label.textColor = DSKitAsset.Colors.gray5.color
        return label
    }()
    
    private let gradeInfoImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = DSKitAsset.Images.icInfo.image
        return imageView
    }()
    ...
    private let settingTableView: UITableView = {
        ...
        tableView.backgroundColor = DSKitAsset.Colors.white.color
