...
protocol SignUpCoordinatorActions: CoordinatorActions {
    func pushTabBar()
}

final class SignUpViewModel: NagazaViewModel {
    private weak var actions: SignUpCoordinatorActions?
    ...
    func setCoordinatorActions(with actions: CoordinatorActions) {
        self.actions = actions as? SignUpCoordinatorActions
    }
