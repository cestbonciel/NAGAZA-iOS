...
final class ReviewCell: UITableViewCell {
    ...
    private let profileImageView: UIImageView = {
        ...
        imageView.image = DSKitAsset.Images.dummy.image
    ...
    private let ratingView: UIImageView = {
        ...
        imageView.image = DSKitAsset.Images.icLv5.image
    ...
    private let contentsLabel: UILabel = {
        ...
        label.textColor = DSKitAsset.Colors.gray1.color
    ...
    private lazy var infoStackView: UIStackView = {
        ...
        stackView.layer.borderColor = DSKitAsset.Colors.gray8.color.cgColor
    ...
    private let lineView: UIView = {
        ...
        view.backgroundColor = DSKitAsset.Colors.gray8.color
    ...
    private let themeMoreImageView: UIImageView = {
        ...
        imageView.image = DSKitAsset.Images.icArrowRightGray.image
    ...
    private let cafeReviewLabel: UILabel = {
        ...
        label.text = "리뷰 25개"
        label.font = DSKitFontFamily.Pretendard.medium.font(size: 10)
    ...
    private func setCollectionViewHeight() {
        ...
        let tagWidth: CGFloat = "#".widthOfFont(usingFont: DSKitFontFamily.Pretendard.regular.font(size: 12))
        var totalWidth: CGFloat = 0
        
        for (index, dao) in dataList.enumerated() {
            
            var itemWidth = dao.widthOfFont(usingFont: DSKitFontFamily.Pretendard.regular.font(size: 12)) + 20
            itemWidth += tagWidth
        ...
        let itemHeight = dataList[0].heightOfFont(usingFont: DSKitFontFamily.Pretendard.regular.font(size: 12)) + 20
